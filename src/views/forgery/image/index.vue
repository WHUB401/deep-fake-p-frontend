...
import { getImagesResultTar, startDetectionAllImages } from '@/api/forgery'
...
export default {
  ...
  data() {
    return {
      ...
      item: {
        name: 'result.tar',
        src: process.env.BASE_API + '/forgeryDetection/downloadImageResult'
      }
    }
  },
  computed: {
  ...
  methods: {
    ...
    startDetection() {
      ...
      startDetectionAllImages().then(function(resp) {
        Message({
